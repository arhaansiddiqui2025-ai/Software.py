...
# ---------- SALARIES PAGE ----------
    ...
    with col1:  
        ...
        roles = ["Frontend", "Backend", "Full Stack", "DevOps", "Mobile", "Data Engineer", "AI/ML", "Cloud"]
        salary_data = {  
            "Role": roles,  
...
# ---------- TOP INDIAN COLLEGES ----------
    ...
    with col1:  
        ...
        # Re-structured dictionary tracking array properties step-by-step
        st.table({
            "College": [c[0] for c in colleges],   
...
# ---------- TRENDS PAGE ----------
    ...
    with col1:  
        ...
        # Re-structured using explicit key values mapped cleanly into structural DataFrames
        skill_df = pd.DataFrame({  
            "Demand Score": [95, 92, 85, 88, 82, 78, 75, 80]  
        }, index=["Python", "AI/ML", "Java", "JavaScript", "Cloud", "DevOps", "SQL", "React"])  
        
        st.bar_chart(skill_df, height=300)  
    ...
    with col2:  
        ...
        }, index=["AI/ML", "Cloud", "DevOps", "Data Science", "Full Stack", "Mobile", "Frontend"])  
        
        st.bar_chart(growth_df, height=300)  
